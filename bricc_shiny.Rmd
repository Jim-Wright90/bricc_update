...
bricc_demo$group <- factor(bricc_demo$group, levels = c("Winter 2020",
                                              "Spring 2020",
                                              "Summer 2020",
                                              "Fall 2020 1st Years",
                                              "Fall 2020 2nd Years",
...
selectInput("terms",
            "Term Number",
            choices = levels(term_means$term))
...
renderPlotly({
  ...
  labs(x = "",
       y = "Score",
       title = paste("Average Scores:", input$terms))
})
