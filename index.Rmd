...
bricc_means$group <- factor(bricc_means$group, levels = c("Winter 2020", "Spring 2020"))
...
## Group Average
```{r group average plot, include=TRUE}
mean_plot
```

## Term Average
```{r term average plot, include=TRUE}
term_plot
```
...
q1$group <- factor(q1$group, levels = c("Winter 2020", "Spring 2020"))
...
q2$group <- factor(q2$group, levels = c("Winter 2020", "Spring 2020"))
```
...
q3$group <- factor(q3$group, levels = c("Winter 2020", "Spring 2020"))
```
...
q4$group <- factor(q4$group, levels = c("Winter 2020", "Spring 2020"))
```
...
q5$group <- factor(q5$group, levels = c("Winter 2020", "Spring 2020"))
```
...
q6$group <- factor(q6$group, levels = c("Winter 2020", "Spring 2020"))
```
...
q7$group <- factor(q7$group, levels = c("Winter 2020", "Spring 2020"))
```
...
q8$group <- factor(q8$group, levels = c("Winter 2020", "Spring 2020"))
```
...
q9$group <- factor(q9$group, levels = c("Winter 2020", "Spring 2020"))
```
...
q10$group <- factor(q10$group, levels = c("Winter 2020", "Spring 2020"))
```
...
q11$group <- factor(q11$group, levels = c("Winter 2020", "Spring 2020"))
```
...
q12$group <- factor(q12$group, levels = c("Winter 2020", "Spring 2020"))
```
...
q13$group <- factor(q13$group, levels = c("Winter 2020", "Spring 2020"))
```
...
q14$group <- factor(q14$group, levels = c("Winter 2020", "Spring 2020"))
```
...
q15$group <- factor(q15$group, levels = c("Winter 2020", "Spring 2020"))
```
...
q16$group <- factor(q16$group, levels = c("Winter 2020", "Spring 2020"))
```
...
q17$group <- factor(q17$group, levels = c("Winter 2020", "Spring 2020"))
```
...
q18$group <- factor(q18$group, levels = c("Winter 2020", "Spring 2020"))
```
...
q19$group <- factor(q19$group, levels = c("Winter 2020", "Spring 2020"))
```
...
q20$group <- factor(q20$group, levels = c("Winter 2020", "Spring 2020"))
```
...
q21$group <- factor(q21$group, levels = c("Winter 2020", "Spring 2020"))
```
...
q22$group <- factor(q22$group, levels = c("Winter 2020", "Spring 2020"))
```
...
q23$group <- factor(q23$group, levels = c("Winter 2020", "Spring 2020"))
```
...
q24$group <- factor(q24$group, levels = c("Winter 2020", "Spring 2020"))
```
...
q25$group <- factor(q25$group, levels = c("Winter 2020", "Spring 2020"))
```
...
q26$group <- factor(q26$group, levels = c("Winter 2020", "Spring 2020"))
```
...
q27$group <- factor(q27$group, levels = c("Winter 2020", "Spring 2020"))
```
